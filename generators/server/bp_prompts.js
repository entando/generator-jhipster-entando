...
function askForServerSideOpts(meta) {
    ...
    const prompts = [
        ...
        },
        {
            ...
            type: 'list',
            name: 'oauth2Config',
            message: 'Do you want to use standard JHipster OAuth2 configuration or manually configure a remote token service?',
            choices: () => {
                const opts = [];
                opts.push({
                    value: 'customRemoteTokenService',
                    name: 'I want to configure a remote token service'
                });
                opts.push({
                    value: 'defaultOauth2Config',
                    name: 'Use JHipster default OAuth2 configuration'
                });
                return opts;
            }
        },
        ...
        },
        {
            ...
            choices: [
                {
                    value: 'springDataRest',
                    name: 'Use Spring Data Rest'
                },
                {
                    value: 'jhipsterDefaultResource',
                    name: 'Use JHipster default resources'
                }
            ],
            default: 0
        },
    ...
    this.prompt(prompts).then(props => {
        ...
        this.customRemoteTokenService = props.oauth2Config === 'customRemoteTokenService';
        ...
        this.useSpringDataRest = props.springDataRest === 'springDataRest';
